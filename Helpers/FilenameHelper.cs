...
public class FilenameHelper
{
    ...
    /// For both https://download.geofabrik.de/ and app country picker
    ...
    /// <summary>
    /// Method <c>GetCountryCodeFromCountryWhenTranslated</c>.
    ...
    /// </returns>
    public static string GetCountryCodeFromCountryWhenTranslated(string country)
    {
        return country switch
        {
